...
public class GenerateObjecTestUtil {
	...
	public static TravelDTO generateTestCreationTravelDTO() {
		...
		travelDTO.setReservationDTO(List.of(generateTestCreationReservationDTO()));
	...
	public static Travel generateTestCreationTravel() {
		...
		travel.setReservation(List.of(generateTestCreationReservation()));
